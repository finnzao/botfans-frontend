        ...
        <div style={styles.row}>
          ...
          <div style={styles.info}>
            <div style={styles.statusRow}>
              ...
              <span style={styles.statusLabel}>Telegram conectado</span>
            </div>
            {phone && (
              <span style={styles.phone}>{formatPhone(phone)}</span>
            )}
        ...
        <div style={styles.row}>
          ...
          <div style={styles.info}>
            <div style={styles.statusRow}>
              ...
              <span style={{ ...styles.statusLabel, color: 'var(--amber)' }}>Desconectado</span>
            </div>
          ...
          <button
            ...
            style={{ ...styles.reconnectBtn, opacity: reconnecting ? 0.6 : 1 }}
          >
